...
const LoginPage = ({ onClose }) => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const syncResult = await syncAuth0Profile(pending.role);
        ...
        console.error('Auth0 redirect sync failed:', err);
  ...
  }, [getIdTokenClaims, isAuthenticated, isLoading, navigate, syncAuth0Profile]);
